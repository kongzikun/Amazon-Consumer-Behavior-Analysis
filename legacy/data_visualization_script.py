...
def save_academic_figure(fig, filename):
    ...
    fig.write_html(f"interactive_html/{filename}.html", include_plotlyjs='cdn')
    ...
    fig_for_png.write_image(f"images/{filename}.png", width=2400, height=1600, scale=3)
    print(f"✅ Publication-grade figure saved: {filename}")


## Core Data Loading and Preprocessing Module
class AmazonDataProcessor:
    def __init__(self, purchases_path, survey_path): self.purchases_path = purchases_path; self.survey_path = survey_path
    def load_and_process(self):
        ...
        except FileNotFoundError as e: return print(f"Error: {e}. Please check file paths.")
...
class AmazonDataAnalyzer:
    ...
    def run_complete_analysis(self):
        ...
        print("📂 Publication-ready files saved to 'images/' and 'interactive_html/'")

## Main Execution Block
if __name__ == "__main__":
    try:
        # IMPORTANT: Update these paths to the location of your data files
        purchases_file = '/Users/tianyi_lyu/Library/CloudStorage/OneDrive-Audencia/大三下课程/数据可视化/Final Project/代码实现/数据集/amazon-purchases.csv'
        survey_file = '/Users/tianyi_lyu/Library/CloudStorage/OneDrive-Audencia/大三下课程/数据可视化/Final Project/代码实现/数据集/survey.csv'
        analyzer = AmazonDataAnalyzer(purchases_path=purchases_file, survey_path=survey_file)
